...
import kotlinx.android.synthetic.main.fragment_batch14.view.*
...
class Batch14 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_batch14, container, false)

        recyclerView = view.recyclerView_batch_14
